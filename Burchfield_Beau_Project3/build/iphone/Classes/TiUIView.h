...
/**
 Base class for all Burchfield_Beau_Project3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Burchfield_Beau_Project3 view hierarchy (such as wrapped iOS UIViews) was touched.
