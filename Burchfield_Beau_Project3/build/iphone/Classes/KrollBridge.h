...
@interface Burchfield_Beau_Project3Object : KrollCoverageObject {
#else
@interface Burchfield_Beau_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Burchfield_Beau_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Burchfield_Beau_Project3Object *_burchfield_beau_project3;
    KrollObject* console;
	BOOL shutdown;
