...
//Rare exceptions to indicate a bug in the _burchfield_beau_project3 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Burchfield_Beau_Project3 proxies.
 */
