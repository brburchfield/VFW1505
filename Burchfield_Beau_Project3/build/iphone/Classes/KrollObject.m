...
//@interface Burchfield_Beau_Project3Object : NSObject
//@end

@interface Burchfield_Beau_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Burchfield_Beau_Project3Object class]])
		{
			for (NSString *key in [[(Burchfield_Beau_Project3Object*)o modules] allKeys])
			{
