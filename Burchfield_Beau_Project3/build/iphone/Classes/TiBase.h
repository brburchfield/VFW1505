...
// in simulator we redefine to format for Burchfield_Beau_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.burchfield_beau_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.burchfield_beau_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBurchfield_Beau_Project3NativeItemNone = -1, 
	UIBurchfield_Beau_Project3NativeItemSpinner = -2,
	UIBurchfield_Beau_Project3NativeItemProgressBar = -3,
	
	UIBurchfield_Beau_Project3NativeItemSlider = -4,
	UIBurchfield_Beau_Project3NativeItemSwitch = -5,
	UIBurchfield_Beau_Project3NativeItemMultiButton = -6,
	UIBurchfield_Beau_Project3NativeItemSegmented = -7,
	
	UIBurchfield_Beau_Project3NativeItemTextView = -8,
	UIBurchfield_Beau_Project3NativeItemTextField = -9,
	UIBurchfield_Beau_Project3NativeItemSearchBar = -10,
	
	UIBurchfield_Beau_Project3NativeItemPicker = -11,
	UIBurchfield_Beau_Project3NativeItemDatePicker = -12,
	
	UIBurchfield_Beau_Project3NativeItemInfoLight = -13,
	UIBurchfield_Beau_Project3NativeItemInfoDark = -14,
	
	UIBurchfield_Beau_Project3NativeItemDisclosure = -15,
	
	UIBurchfield_Beau_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Burchfield_Beau_Project3 instances of
