...
/**
 The base class for all Burchfield_Beau_Project3 modules
 */
...
/**
 Burchfield_Beau_Project3 Platform calls this method on startup.
 */
-(void)startup;

/**
 Burchfield_Beau_Project3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Burchfield_Beau_Project3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Burchfield_Beau_Project3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Burchfield_Beau_Project3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
