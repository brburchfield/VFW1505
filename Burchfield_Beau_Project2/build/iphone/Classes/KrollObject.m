...
//@interface Burchfield_Beau_Project2Object : NSObject
//@end

@interface Burchfield_Beau_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Burchfield_Beau_Project2Object class]])
		{
			for (NSString *key in [[(Burchfield_Beau_Project2Object*)o modules] allKeys])
			{
