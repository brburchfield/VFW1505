...
@interface Burchfield_Beau_Project2Object : KrollCoverageObject {
#else
@interface Burchfield_Beau_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Burchfield_Beau_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Burchfield_Beau_Project2Object *_burchfield_beau_project2;
    KrollObject* console;
	BOOL shutdown;
