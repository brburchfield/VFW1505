...
// in simulator we redefine to format for Burchfield_Beau_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.burchfield_beau_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.burchfield_beau_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBurchfield_Beau_Project2NativeItemNone = -1, 
	UIBurchfield_Beau_Project2NativeItemSpinner = -2,
	UIBurchfield_Beau_Project2NativeItemProgressBar = -3,
	
	UIBurchfield_Beau_Project2NativeItemSlider = -4,
	UIBurchfield_Beau_Project2NativeItemSwitch = -5,
	UIBurchfield_Beau_Project2NativeItemMultiButton = -6,
	UIBurchfield_Beau_Project2NativeItemSegmented = -7,
	
	UIBurchfield_Beau_Project2NativeItemTextView = -8,
	UIBurchfield_Beau_Project2NativeItemTextField = -9,
	UIBurchfield_Beau_Project2NativeItemSearchBar = -10,
	
	UIBurchfield_Beau_Project2NativeItemPicker = -11,
	UIBurchfield_Beau_Project2NativeItemDatePicker = -12,
	
	UIBurchfield_Beau_Project2NativeItemInfoLight = -13,
	UIBurchfield_Beau_Project2NativeItemInfoDark = -14,
	
	UIBurchfield_Beau_Project2NativeItemDisclosure = -15,
	
	UIBurchfield_Beau_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Burchfield_Beau_Project2 instances of
