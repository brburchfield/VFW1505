...
// in simulator we redefine to format for Burchfield_Beau_Week3GoToTrainingReflection Developer console
...
{\
	NSString * exceptionName = [@"org.burchfield_beau_week3gototrainingreflection." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.burchfield_beau_week3gototrainingreflection";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemNone = -1, 
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemSpinner = -2,
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemProgressBar = -3,
	
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemSlider = -4,
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemSwitch = -5,
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemMultiButton = -6,
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemSegmented = -7,
	
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemTextView = -8,
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemTextField = -9,
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemSearchBar = -10,
	
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemPicker = -11,
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemDatePicker = -12,
	
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemInfoLight = -13,
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemInfoDark = -14,
	
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemDisclosure = -15,
	
	UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Burchfield_Beau_Week3GoToTrainingReflection instances of
