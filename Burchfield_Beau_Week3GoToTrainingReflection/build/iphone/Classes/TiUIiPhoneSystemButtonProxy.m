...
MAKE_SYSTEM_PROP(ACTIVITY,UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIBurchfield_Beau_Week3GoToTrainingReflectionNativeItemContactAdd);
