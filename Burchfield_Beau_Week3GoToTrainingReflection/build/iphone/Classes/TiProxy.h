...
//Rare exceptions to indicate a bug in the _burchfield_beau_week3gototrainingreflection code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Burchfield_Beau_Week3GoToTrainingReflection proxies.
 */
