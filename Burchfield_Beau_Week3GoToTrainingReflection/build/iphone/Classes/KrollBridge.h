...
@interface Burchfield_Beau_Week3GoToTrainingReflectionObject : KrollCoverageObject {
#else
@interface Burchfield_Beau_Week3GoToTrainingReflectionObject : KrollObject {
#endif
@private
...
extern NSString * Burchfield_Beau_Week3GoToTrainingReflection$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Burchfield_Beau_Week3GoToTrainingReflectionObject *_burchfield_beau_week3gototrainingreflection;
    KrollObject* console;
	BOOL shutdown;
