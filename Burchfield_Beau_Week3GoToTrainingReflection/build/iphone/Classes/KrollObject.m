...
//@interface Burchfield_Beau_Week3GoToTrainingReflectionObject : NSObject
//@end

@interface Burchfield_Beau_Week3GoToTrainingReflectionObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Burchfield_Beau_Week3GoToTrainingReflectionObject class]])
		{
			for (NSString *key in [[(Burchfield_Beau_Week3GoToTrainingReflectionObject*)o modules] allKeys])
			{
