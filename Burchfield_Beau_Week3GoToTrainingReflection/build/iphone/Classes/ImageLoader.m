...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.burchfield_beau_week3gototrainingreflection._burchfield_beau_week3gototrainingreflection.imageloader" code:1 userInfo:errorDetail];
