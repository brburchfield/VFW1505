 ...
 * to send analytic data that can be viewed on the Burchfield_Beau_Week3GoToTrainingReflection Dashboard.
 *
 * For information on getting started with Burchfield_Beau_Week3GoToTrainingReflection Platform Services,
