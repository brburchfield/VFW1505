...
@interface Week2GoToResponeObject : KrollCoverageObject {
#else
@interface Week2GoToResponeObject : KrollObject {
#endif
@private
...
extern NSString * Week2GoToRespone$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Week2GoToResponeObject *_week2gotorespone;
    KrollObject* console;
	BOOL shutdown;
