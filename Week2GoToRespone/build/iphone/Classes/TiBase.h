...
// in simulator we redefine to format for Week2GoToRespone Developer console
...
{\
	NSString * exceptionName = [@"org.week2gotorespone." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week2gotorespone";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek2GoToResponeNativeItemNone = -1, 
	UIWeek2GoToResponeNativeItemSpinner = -2,
	UIWeek2GoToResponeNativeItemProgressBar = -3,
	
	UIWeek2GoToResponeNativeItemSlider = -4,
	UIWeek2GoToResponeNativeItemSwitch = -5,
	UIWeek2GoToResponeNativeItemMultiButton = -6,
	UIWeek2GoToResponeNativeItemSegmented = -7,
	
	UIWeek2GoToResponeNativeItemTextView = -8,
	UIWeek2GoToResponeNativeItemTextField = -9,
	UIWeek2GoToResponeNativeItemSearchBar = -10,
	
	UIWeek2GoToResponeNativeItemPicker = -11,
	UIWeek2GoToResponeNativeItemDatePicker = -12,
	
	UIWeek2GoToResponeNativeItemInfoLight = -13,
	UIWeek2GoToResponeNativeItemInfoDark = -14,
	
	UIWeek2GoToResponeNativeItemDisclosure = -15,
	
	UIWeek2GoToResponeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week2GoToRespone instances of
