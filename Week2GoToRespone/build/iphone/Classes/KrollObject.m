...
//@interface Week2GoToResponeObject : NSObject
//@end

@interface Week2GoToResponeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week2GoToResponeObject class]])
		{
			for (NSString *key in [[(Week2GoToResponeObject*)o modules] allKeys])
			{
