...
/**
 Base class for all Week2GoToRespone views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week2GoToRespone view hierarchy (such as wrapped iOS UIViews) was touched.
