...
//Rare exceptions to indicate a bug in the _week2gotorespone code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Week2GoToRespone proxies.
 */
