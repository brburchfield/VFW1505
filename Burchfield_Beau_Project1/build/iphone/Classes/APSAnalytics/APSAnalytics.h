 ...
 * to send analytic data that can be viewed on the Burchfield_Beau_Project1 Dashboard.
 *
 * For information on getting started with Burchfield_Beau_Project1 Platform Services,
