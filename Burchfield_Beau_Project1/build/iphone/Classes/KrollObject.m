...
//@interface Burchfield_Beau_Project1Object : NSObject
//@end

@interface Burchfield_Beau_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Burchfield_Beau_Project1Object class]])
		{
			for (NSString *key in [[(Burchfield_Beau_Project1Object*)o modules] allKeys])
			{
