...
// in simulator we redefine to format for Burchfield_Beau_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.burchfield_beau_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.burchfield_beau_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBurchfield_Beau_Project1NativeItemNone = -1, 
	UIBurchfield_Beau_Project1NativeItemSpinner = -2,
	UIBurchfield_Beau_Project1NativeItemProgressBar = -3,
	
	UIBurchfield_Beau_Project1NativeItemSlider = -4,
	UIBurchfield_Beau_Project1NativeItemSwitch = -5,
	UIBurchfield_Beau_Project1NativeItemMultiButton = -6,
	UIBurchfield_Beau_Project1NativeItemSegmented = -7,
	
	UIBurchfield_Beau_Project1NativeItemTextView = -8,
	UIBurchfield_Beau_Project1NativeItemTextField = -9,
	UIBurchfield_Beau_Project1NativeItemSearchBar = -10,
	
	UIBurchfield_Beau_Project1NativeItemPicker = -11,
	UIBurchfield_Beau_Project1NativeItemDatePicker = -12,
	
	UIBurchfield_Beau_Project1NativeItemInfoLight = -13,
	UIBurchfield_Beau_Project1NativeItemInfoDark = -14,
	
	UIBurchfield_Beau_Project1NativeItemDisclosure = -15,
	
	UIBurchfield_Beau_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Burchfield_Beau_Project1 instances of
