...
@interface Burchfield_Beau_Project1Object : KrollCoverageObject {
#else
@interface Burchfield_Beau_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Burchfield_Beau_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Burchfield_Beau_Project1Object *_burchfield_beau_project1;
    KrollObject* console;
	BOOL shutdown;
