...
/**
 Base class for all DefaultProjecte views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the DefaultProjecte view hierarchy (such as wrapped iOS UIViews) was touched.
