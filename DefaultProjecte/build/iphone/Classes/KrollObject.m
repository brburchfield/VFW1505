...
//@interface DefaultProjecteObject : NSObject
//@end

@interface DefaultProjecteObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DefaultProjecteObject class]])
		{
			for (NSString *key in [[(DefaultProjecteObject*)o modules] allKeys])
			{
