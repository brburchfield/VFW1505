...
//Rare exceptions to indicate a bug in the _defaultprojecte code (Eg, function that a subclass should have implemented)
...
/**
 The base class for DefaultProjecte proxies.
 */
