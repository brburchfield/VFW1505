...
// in simulator we redefine to format for DefaultProjecte Developer console
...
{\
	NSString * exceptionName = [@"org.defaultprojecte." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.defaultprojecte";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDefaultProjecteNativeItemNone = -1, 
	UIDefaultProjecteNativeItemSpinner = -2,
	UIDefaultProjecteNativeItemProgressBar = -3,
	
	UIDefaultProjecteNativeItemSlider = -4,
	UIDefaultProjecteNativeItemSwitch = -5,
	UIDefaultProjecteNativeItemMultiButton = -6,
	UIDefaultProjecteNativeItemSegmented = -7,
	
	UIDefaultProjecteNativeItemTextView = -8,
	UIDefaultProjecteNativeItemTextField = -9,
	UIDefaultProjecteNativeItemSearchBar = -10,
	
	UIDefaultProjecteNativeItemPicker = -11,
	UIDefaultProjecteNativeItemDatePicker = -12,
	
	UIDefaultProjecteNativeItemInfoLight = -13,
	UIDefaultProjecteNativeItemInfoDark = -14,
	
	UIDefaultProjecteNativeItemDisclosure = -15,
	
	UIDefaultProjecteNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DefaultProjecte instances of
