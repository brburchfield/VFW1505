...
@interface DefaultProjecteObject : KrollCoverageObject {
#else
@interface DefaultProjecteObject : KrollObject {
#endif
@private
...
extern NSString * DefaultProjecte$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	DefaultProjecteObject *_defaultprojecte;
    KrollObject* console;
	BOOL shutdown;
