...
//@interface Burchfield_Beau_Project4Object : NSObject
//@end

@interface Burchfield_Beau_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Burchfield_Beau_Project4Object class]])
		{
			for (NSString *key in [[(Burchfield_Beau_Project4Object*)o modules] allKeys])
			{
