...
// in simulator we redefine to format for Burchfield_Beau_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.burchfield_beau_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.burchfield_beau_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBurchfield_Beau_Project4NativeItemNone = -1, 
	UIBurchfield_Beau_Project4NativeItemSpinner = -2,
	UIBurchfield_Beau_Project4NativeItemProgressBar = -3,
	
	UIBurchfield_Beau_Project4NativeItemSlider = -4,
	UIBurchfield_Beau_Project4NativeItemSwitch = -5,
	UIBurchfield_Beau_Project4NativeItemMultiButton = -6,
	UIBurchfield_Beau_Project4NativeItemSegmented = -7,
	
	UIBurchfield_Beau_Project4NativeItemTextView = -8,
	UIBurchfield_Beau_Project4NativeItemTextField = -9,
	UIBurchfield_Beau_Project4NativeItemSearchBar = -10,
	
	UIBurchfield_Beau_Project4NativeItemPicker = -11,
	UIBurchfield_Beau_Project4NativeItemDatePicker = -12,
	
	UIBurchfield_Beau_Project4NativeItemInfoLight = -13,
	UIBurchfield_Beau_Project4NativeItemInfoDark = -14,
	
	UIBurchfield_Beau_Project4NativeItemDisclosure = -15,
	
	UIBurchfield_Beau_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Burchfield_Beau_Project4 instances of
