...
@interface Burchfield_Beau_Project4Object : KrollCoverageObject {
#else
@interface Burchfield_Beau_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Burchfield_Beau_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Burchfield_Beau_Project4Object *_burchfield_beau_project4;
    KrollObject* console;
	BOOL shutdown;
