...
/**
 Base class for all Burchfield_Beau_Project4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Burchfield_Beau_Project4 view hierarchy (such as wrapped iOS UIViews) was touched.
